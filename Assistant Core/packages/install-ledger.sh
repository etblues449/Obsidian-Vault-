...
SHA_LEDGER="f17cf711c47360c3318bbfdd4150c5db550c126d41d11ffbefd6b1ef06884035"
...
fetch ledger.mjs .ledger.new "$SHA_LEDGER"
fetch patch-ledger.mjs .patch-ledger.new "$SHA_PATCH"
fetch jarvis-ledger.mjs .cli-ledger.new "$SHA_CLI"

grep -q 'NEVER AUTO-REPLAY' .ledger.new || { echo "x fetched ledger is not the Phase 4 version (stale cache)"; rm -f .ledger.new .patch-ledger.new .cli-ledger.new; exit 1; }
...
# --- gate 4: the app must still boot -----------------------------------------
