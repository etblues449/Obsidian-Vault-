# Org Structure Reference (June 2025)

Source: company org chart provided.

> ⚠️ User flagged this as **"old"**. Use as starting point but flag any names that don't show up in mailbox correspondence — they may have left, and any names in mailbox not on this list need adding.
...
Regional Managers:
- **Jeri-Lee Saunders** — Regent House: Stafford Road, St Marks, Horsehills Drive, Oaks Crescent, Fellows Road, Dudding Road, St John Square, Himley Road
- **Donna Poole** — Senior Regional Manager, Union Park: Peacock Close, Vicarage Road, Beeches Road, Stony Lane, Greswold Street, Moor Lane, Tiverton Drive, The Bantocks
- **(TBC)** — Old Bank: Hawbush Road, Harrison Street, Doveridge Place, Walsall Road, Oberon Grove
- **Samantha Morrison** — Regional Manager (Registered CQC Manager): Lincoln Road, Stratford Road *(Residential Services)*

Registered CQC Managers:
- **Doris Ukwu** — New Peak: Knipersley Road, Goodison Gardens, Penns Lane
- **Stacey Turner** — Mil Water: Chester Road, Marsons Court
- **Jennifer Currier** — All Saints Way
- **Sangeeta Rani / Aneel Jassal** — Helenny Close
- **Carol Austin** — John Street
