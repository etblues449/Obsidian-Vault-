...
description: Single-file HTML app converting uploaded docs to Podcast / Video / Lesson formats via Anthropic API
type: project
---
...
**Why:** Built for academic / coursework use. Source material is Cost Management content (product lifecycle, target costing, value analysis, lifecycle costing) — tied to ongoing exam prep / studying.
