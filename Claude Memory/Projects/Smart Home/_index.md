...
- [ ] **Back up hub-side config into the vault** (`automations.yaml`, `bedroom-2.yaml`, `frigate.yaml`, scenes/scripts → `ha-config/`) — the ~19 lounge automations exist nowhere but the hub
