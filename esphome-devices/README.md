...
Content on devices.esphome.io is generated by [Docusaurus](https://docusaurus.io/). Pages are written in Markdown which anyone can learn. How to add a new device is [documented here](https://devices.esphome.io/adding-devices.md).
